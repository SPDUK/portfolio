...
export const WorkHistory = () => (
  <section className="work-section" id="work">
    ...
    <div className="work-overview glass-panel">
      <div>
    ...
    <div className="work-case-grid">
      {caseStudies.map(({ title, eyebrow, image, summary, points }) => (
        <article className="work-case-card glass-panel" key={title}>
    ...
    <aside className="work-ai-note glass-panel">
      <Bot aria-hidden="true" />
      <div>
        <h3>AI engineering focus</h3>
        <p>
          I build with Codex, Claude Code, Cursor, and agentic workflows as part
          of my day-to-day process, then turn that learning into demos,
